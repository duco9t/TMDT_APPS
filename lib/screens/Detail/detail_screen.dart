...
class DetailScreen extends StatefulWidget {
  ...
  const DetailScreen({super.key, required this.popularTshirtBar});
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    super.initState();
    reviewData = fetchReviews(widget.popularTshirtBar.id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: AddToCart(popularTshirtBar: widget.popularTshirtBar),
      ),
          ...
          slivers: [
            ...
            SliverList(
              delegate: SliverChildListDelegate([
                ...
                MyImageSlider(
                  images: [widget.popularTshirtBar.imageUrl],
                  onChange: (index) {
                    setState(() {
                      currentImage = index;
                    });
